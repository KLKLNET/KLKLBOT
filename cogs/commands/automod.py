        ...
        async def enable_logging_callback(interaction):
            ...
            try:
                for channel in interaction.guild.channels:
                    if channel.name == "KLKL-automod":
                        await interaction.response.send_message(f"A logging channel with the name \"KLKL-automod\" already exists.", ephemeral=True)
                        return
                log_channel = await interaction.guild.create_text_channel("KLKL-automod", overwrites=overwrites)
