...
class TimeSelect(Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.set_author(name="Added No Prefix", icon_url="https://cdn.discordapp.com/attachments/1428481917396848793/1429842264502571028/07996634fe922922.png?ex=68f79be1&is=68f64a61&hm=f5b77dd9a9147d51947e1194e36ceb30ba91f6a55912553f11359a4db3bc939f&")
...
class NoPrefix(commands.Cog):
            ...
            if expired_users:
                ...
                for user_id in expired_users:
                    ...
                    if user:
                        ...
                        embed.set_footer(text="KLKL ذ- No Prefix, Join support to regain access.")
    ...
    async def add_np(self, user, duration):
        ...
        embed = discord.Embed(
                            ...
                            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.gg/7Ydjf6874w).",
                            color=0x000000
                        )
        try:
