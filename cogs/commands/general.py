...
class General(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="KLKL Invite !",
      description=
      f"> **[KLKL - Invite Bot](https://discord.com/oauth2/authorize?client_id=1428325344871448626&permissions=8&integration_type=0&scope=bot)**\n>  **[KLKL - Support](https://discord.gg/7Ydjf6874w)**",
      color=0x0ba7ff)
    ...
    invite = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=1428325344871448626&permissions=8&integration_type=0&scope=bot'
    )
