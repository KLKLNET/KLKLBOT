...
class Giveaway(commands.Cog):
        ...
        try:
            ...
            if channel is not None:
                try:
                    ...
                    await message.edit(content="<a:Giveaway:1429858052563271751> **GIVEAWAY ENDED** <a:Giveaway:1429858052563271751>", embed=embed)
    ...
    async def gstart(self, ctx,
        ...
        embed = discord.Embed(title=f"<a:Giveaway:1429858052563271751> {prize}",
                              description=f"Winner(s): **{winners}**\nReact with <a:Giveaway:1429858052563271751> to participate!\nEnds <t:{round(ends)}:R> (<t:{round(ends)}:f>)\n\nHosted by {ctx.author.mention}", color=0x000000)
        ...
        embed.set_thumbnail(url="https://cdn3.emoji.gg/emojis/3899-gift.gif")
        embed.set_footer(text=f"Ends at", icon_url=ctx.bot.user.avatar.url)

        message = await ctx.send("<a:Giveaway:1429858052563271751> **GIVEAWAY** <a:Giveaway:1429858052563271751>", embed=embed)
        try:
