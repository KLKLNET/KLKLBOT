...
class Hide(commands.Cog):
    ...
    async def hide_command(self, ctx, channel: discord.TextChannel = None):
        ...
        if not channel.permissions_for(ctx.guild.default_role).read_messages:
            ...
            embed.set_author(name=f"{channel.name} is Already Hidden", icon_url="https://cdn.discordapp.com/attachments/1428481917396848793/1429842264502571028/07996634fe922922.png?ex=68f79be1&is=68f64a61&hm=f5b77dd9a9147d51947e1194e36ceb30ba91f6a55912553f11359a4db3bc939f&")
        ...
        embed.set_author(name=f"Successfully Hidden {channel.name}", icon_url="https://cdn.discordapp.com/attachments/1428481917396848793/1429842264502571028/07996634fe922922.png?ex=68f79be1&is=68f64a61&hm=f5b77dd9a9147d51947e1194e36ceb30ba91f6a55912553f11359a4db3bc939f&")
        embed.set_footer(text=f"Requested by {ctx.author}", icon_url=ctx.author.avatar.url)
        view = HideUnhideView(channel=channel, author=ctx.author, ctx=ctx) 
        message = await ctx.send(embed=embed, view=view)
        view.message = message
...
@Author: klkl
    + Discord: me.sonu
    + Community: https://discord.gg/klkl Development)
